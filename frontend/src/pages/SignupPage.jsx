      ...
      <div className="bg-card border border-border rounded-3xl p-8 md:p-12 w-full max-w-md shadow-xl animate-fade-in-up">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="text" placeholder="Gordon Ramsay" className="w-full bg-cream border-1.5 border-border rounded-xl px-4 py-3 text-sm focus:border-gold outline-none transition-colors" />
          </div>
          <div>
            <label className="block text-xs font-bold text-muted uppercase tracking-wider mb-2">Email address</label>
            <input type="email" placeholder="you@example.com" className="w-full bg-cream border-1.5 border-border rounded-xl px-4 py-3 text-sm focus:border-gold outline-none transition-colors" />
          </div>
          <div>
            <label className="block text-xs font-bold text-muted uppercase tracking-wider mb-2">Password</label>
            <input type="password" placeholder="Create a strong password" className="w-full bg-cream border-1.5 border-border rounded-xl px-4 py-3 text-sm focus:border-gold outline-none transition-colors" />
          </div>
        </div>
        
        <button 
          onClick={() => onNavigate('dashboard')}
          className="w-full bg-dark text-cream py-4 rounded-xl font-bold text-sm mt-8 hover:bg-olive transition-colors cursor-pointer"
        >
          Create Account →
        </button>
