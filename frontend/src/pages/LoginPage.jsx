      ...
      <div className="bg-card border border-border rounded-3xl p-8 md:p-12 w-full max-w-md shadow-xl animate-fade-in-up">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input type="password" placeholder="••••••••" className="w-full bg-cream border-1.5 border-border rounded-xl px-4 py-3 text-sm focus:border-gold outline-none transition-colors" />
          </div>
        </div>
        ...
        <div className="text-center mt-6 text-sm text-muted">
          Don't have an account? <span onClick={() => onNavigate('signup')} className="text-dark font-bold underline cursor-pointer">Sign up free</span>
        </div>
      </div>
    </div>
  );
